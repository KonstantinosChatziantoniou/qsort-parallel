...
Three different versions of parallel programms have to be made, using:
...
<br>
The programms should check if the result is correct and work for $2^{p}$ threads where $p \in [1:8]$ and for $2^{n}$ elements to be sorted, where $n \in [12:24]$.  
